...
public class View extends JFrame implements ActionListener {
    ...
    private AbstractButton mClearButton;
    ...
    public View(Main pMain) {
        ...
        panelSearch.add(sName);
        mSearchText = new JTextField(20);
